...
<div class="form">
<br>
  <form action="RegisterDelaer.xyz" method="post">
  
    <label for="fname">&nbsp Enter Dealer Id:</label>
				<input id="dealer" type="text" name="dealer"
					required="required" ><span id="span9" style="color:red"></span>
				<label for="fname">&nbsp Enter Company Name:</label>
				<input id="company" type="text" name="company"
				required="required"><span id="span10" style="color:red"></span>
			
				<label for="fname">&nbsp Enter First Name:</label>
				<input type="text" name="fname" required="required"><span id="span3" style="color:red"></span>
			
				<label for="fname">&nbsp Enter Last Name:</label>
				<input type="text" name="lname" required="required"><span id="span4" style="color:red"></span>
			
				<label for="fname">&nbsp Enter State:</label>
				<select id="listBox" name="state" onchange='selct_district(this.value)'></select><span id="span1" style="color:red"></span>
			
				<label for="fname">&nbsp Enter City:</label>
				<select id='secondlist' name="city"></select><span id="span5" style="color:red"></span>
			
				<label for="fname">&nbsp Enter Telephone:</label>
				<input type="tel" name="tel" required="required"><span id="span8" style="color:red"></span>
			
				<label for="fname">&nbsp Enter Email:</label>
				<input type="email" name="email" required="required"><span id="span7" style="color:red"></span>
			
				<label for="fname">&nbsp Enter PassWord:</label>
				<input type="password" name="pass" required="required"><span id="span2" style="color:red"></span>
