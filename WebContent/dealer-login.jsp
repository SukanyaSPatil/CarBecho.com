...
<div class="form">
<br>
  <form action="LoginDealer.xyz" method="post">
    <label for="fname">&nbsp Enter DealerId</label>
    <input type="text" id="dealerid" name="dealerId" placeholder="Your Dealer Id.." required="required">
<br><br>
    <label for="lname">&nbsp Enter Password</label>
    <input type="password" id="password" name="pass" placeholder="Your Password.." required="required" maxlength="10" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
     <span id="1"></span><br><br><br>
