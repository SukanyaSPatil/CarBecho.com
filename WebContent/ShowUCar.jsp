...
<%List<Car> list=(List<Car>)session2.getAttribute("CarsU"); %>
<table>
<%for(Car c:list){%>

<form action="CardetailsUser.xyz" method="post">
<tr><td>Car Image</td><td><img src=<%=c.getImage()%> width="200px" height="200px"></td></tr>
...
<tr><td>Car Color: </td><td><%=c.getColor() %></td></tr>
<tr><td>Car Available Quantity: </td><td><%=c.getQuantity() %></td></tr>
<tr><td><input type="submit"  value="Deatils" class="button"></td></tr>
</form>
<%}%></table></div>
