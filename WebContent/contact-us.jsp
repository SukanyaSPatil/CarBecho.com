...
<li class="ttr_menu_items_parent dropdown active"><a href="#" class="ttr_menu_items_parent_link_arrow dropdown-toggle"data-toggle="dropdown">
Login</a>
<hr class ="horiz_separator"/>
<ul class="child dropdown-menu" role="menu">
...
<li class="ttr_menu_items_parent dropdown"><a href="#" class="ttr_menu_items_parent_link_active">
Contact Us</a>
<hr class ="horiz_separator"/>
</li>
</ul>
...
<div class="container"><br>
  <form action="/action_page.php">
   <div class="form"> <label for="fname">First Name</label><br>
    ...
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px; width:50%"></textarea>
...
<div class="ttr_footerLogin_html_row0 row">
<div class="post_column col-lg-3 col-md-6 col-sm-6 col-xs-12">
<div class="ttr_footerLogin_html_column00">
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
...
<div class="post_column col-lg-3 col-md-6 col-sm-6 col-xs-12">
<div class="ttr_footerLogin_html_column01">
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
...
<div class="post_column col-lg-3 col-md-6 col-sm-6 col-xs-12">
<div class="ttr_footerLogin_html_column02">
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
...
<div class="post_column col-lg-3 col-md-6 col-sm-6 col-xs-12">
<div class="ttr_footerLogin_html_column03">
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
