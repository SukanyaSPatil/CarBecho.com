...
<div class="form">
	...
	%>
	<%
		List<Car> list = (List<Car>) session2.getAttribute("CarsDetails");
	%>
	<table>
		<%
			for (Car c : list) {
		%>
		<form action="UpdateCarD.xyz" method="get">
		<tr>
				<td>Car Chasis Number:</td>
				<td><%=c.getChasisNumber()%></td>
			</tr>
			<tr>
				<td>Car Image:</td>
				<td><img src="<%=c.getImage()%>" height="200" width="300" /></td>
			</tr>
			<tr>
				<td>Car Model:</td>
				<td><input type="text" id="model" name="model" value='<%=c.getModel()%>'> <input
					type="hidden" name="chasisNo" value='<%=c.getChasisNumber()%>'></td>
			</tr>
			<tr>
				<td>Car Color:</td>
				<td><input type="text" id="color" name="color" value='<%=c.getColor()%>'></td>
			</tr>
			<tr>
				<td>Car Type:</td>
				<td><input type="text" type="text" id="type" name="type" value='<%=c.getType()%>'></td>
			</tr>
			<tr>
				<td>Car Quantity</td>
				<td><input type="text" id="quantity" name="quantity" value='<%=c.getQuantity()%>'></td>
			</tr>
			<tr>
				<td>Car Description:</td>
				<td><input type="text" id="description" name="description" value='<%=c.getDescription()%>'></td>
			</tr>
			<tr>
				<td>Enter Car Engine Number:</td>
				<td><input type="text" id="engineNumber" name="engineNumber" value='<%=c.getEngineNumber()%>'><span
					id="span5" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Enter Car Company:</td>
				<td><%=c.getCompany() %><span
					id="span6" style="color: red"></span></td>
			</tr>
			<tr>
				<td>Car PaymentOption</td>
				<td><input type="text" value='<%=c.getPaymentTerm()%>' id="payTerm" name="payterm"></td>
			</tr>
			<tr>
				<td>Car Price:</td>
				<td><input type="text" value='<%=c.getPrice()%>' id="price" name="price"></td>
			</tr>
			<tr>
				<td>Car Delivery</td>
				<td><input type="text" value='<%=c.getDelivery()%>' id="delivery" name="delivery"></td>
			</tr>
			<tr>
					<td><input type="submit"  value="Update"
					class="button" /></td>
				<!-- <td><a href="UpdateCarD.xyz" class="button">Update</a></td> -->
			</tr>
			<tr>
				<td><a href="DeleteD.xyz?chasisNo=<%=c.getChasisNumber()%>" class="button">Delete</a></td>
