...
<div class="form">
<br>
  <form action="RegisterUser.xyz" method="post">
  
    <label for="fname">&nbsp Enter Your Email ID:</label>
				<input id="dealer" type="text" name="userName"
					required="required" ><span id="span9" style="color:red"></span>
				<label for="fname">&nbsp Enter Your Password:</label>
				<input id="company" type="password" name="password"
				required="required"><span id="span10" style="color:red"></span>
			
				<label for="fname">&nbsp Enter  Your First Name:</label>
				<input  type="text" name="firstName" required="required"><span id="span3" style="color:red"></span>
			
				<label for="fname">&nbsp Enter  Your Last Name:</label>
				<input type="text" name="lastName" required="required"><span id="span4" style="color:red"></span>
				...
				<label for="fname">&nbsp Enter Your Contact Number:</label>
				<input type="text" name="contactNo" required="required"><span id="span8" style="color:red"></span>
			
				<label for="fname">&nbsp Enter Your PIN:</label>
				<input type="text" name="pin" required="required"><span id="span2" style="color:red"></span>
