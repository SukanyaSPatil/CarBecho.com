...
String dealerId=(String)session2.getAttribute("dealerId");
if(dealerId==null){
	response.sendRedirect("DealerLogin.jsp");
}
else{
	session2.setAttribute("dealerId", dealerId);
}
%>
	<div class="form">
		<a href="InsertCar.jsp" class="button">Insert</a><br>
		<a href="ShowDCar.xyz" class="button">Show My Car</a><br>
	</div>
<br><br><br>
