...
<%List<Car> list=(List<Car>)session2.getAttribute("CarsUDetails"); %>
<table>
<%for(Car c:list){%>
<div class="form">
<form action="BookCar.xyz">
<tr><td>Car Image</td><td><img src="<%=c.getImage()%>" height="200" width="300" /></td></tr>
<tr><td>Car Model:</td><td><%=c.getModel()%> <input type="hidden" name="chasisNo" value='<%=c.getChasisNumber() %>'></td></tr>
<tr><td>Car Color:</td><td><%=c.getColor() %>  <input type="hidden" name="dealerId" value='<%=c.getDealer() %>'></td></tr>
<tr><td>Car Type:</td><td><%=c.getType() %></td></tr>
<tr><td>Car Quantity</td><td><%=c.getQuantity() %></td></tr>
<tr><td>Car Description:</td><td><%=c.getDescription() %></td></tr>
<tr><td>Car PaymentOption</td><td><%=c.getPaymentTerm() %></td></tr>
<tr><td>Car Price:</td><td><%=c.getPrice() %></td></tr>
<tr><td>Car Delivery:</td><td><%=c.getDelivery() %></td></tr>
<tr><td><input type="submit" name="action" value="Book" class="button"></td></tr>
</form>
<%}%>
</table>
</div><br><br><br>
