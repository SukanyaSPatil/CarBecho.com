...
<br><br><br>
<div class="form">
<form method="get" action="UpdateCarD.xyz">
		<%
...
session1.setAttribute("chasisNo", chasisNo); %>
		...
		<input type="text" id="model" name="model" placeholder="Your Car Model.." required="required"><span
			  ...
			  <label for="fname">&nbsp Enter Car Type:</label>
				<input type="text" id="type" name="type" placeholder="Your Car Type.." required="required"><span
					id="span3" style="color: red"></span>
					
					<label for="fname">&nbsp  Enter Car Colour:</label>
				<input type="text" id="color" name="color" placeholder="Your Car Colour.." required="required"><span
					id="span4" style="color: red"></span>
		
		      <label for="fname">&nbsp  Enter Car Engine Number:</label>
			...
			<input type="text" id="company" name="company" placeholder="Your Car Company.." required="required"><span
					id="span6" style="color: red"></span>
